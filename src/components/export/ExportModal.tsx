...
export function ExportModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 animate-in fade-in">
      <div className="bg-[#121214] border border-[#27272a] rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden text-zinc-200 flex flex-col">
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-[#27272a] bg-[#18181b]">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-base font-semibold text-[#ededed]">Export 9:16 Vertical Video</h2>
        ...
        <div className="p-6 space-y-5">
          {!isExporting && !downloadUrl && (
            <>
              ...
              {/* Specs Summary */}
              <div className="p-3.5 rounded-xl bg-[#18181b] border border-[#27272a] text-xs space-y-2">
                <div className="text-zinc-300 font-semibold flex items-center justify-between">
                  <span>Render Pipeline Specifications:</span>
                  <span className="text-[11px] font-mono text-zinc-400">Ready</span>
                </div>
          ...
          {isExporting && progress && (
            <div className="space-y-4 py-4">
              ...
              {/* Progress Bar */}
              <div className="w-full bg-[#27272a] h-2.5 rounded-full overflow-hidden p-0.5">
                <div
                  style={{ width: `${progress.percentage}%` }}
                  className="bg-[#ededed] h-full rounded-full transition-all duration-200"
                />
              </div>
          ...
          {downloadUrl && (
            <div className="space-y-4 text-center py-2">
              <div className="w-12 h-12 rounded-full bg-zinc-800 border border-zinc-700 text-[#ededed] flex items-center justify-center mx-auto">
              ...
              <div className="max-w-[200px] mx-auto rounded-xl overflow-hidden border border-[#27272a] aspect-[9/16] bg-black shadow-lg">
                <video
                  src={downloadUrl}
                  controls
                  playsInline
        ...
        <div className="px-6 py-4 border-t border-[#27272a] bg-[#18181b] flex items-center justify-between">
          ...
          {!isExporting && !downloadUrl && (
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-semibold text-[#ededed] bg-[#27272a] hover:bg-[#3f3f46] border border-[#3f3f46] transition cursor-pointer active:scale-95"
            >
          ...
          {downloadUrl && (
            <div className="flex items-center gap-2">
              <button
                type="button"
                onClick={resetModal}
                className="flex items-center gap-1 px-3 py-2 text-xs font-medium text-zinc-300 hover:text-white bg-[#121214] hover:bg-[#27272a] border border-[#27272a] rounded-lg transition cursor-pointer"
              >
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-4 py-2 text-xs font-semibold text-[#ededed] bg-[#27272a] hover:bg-[#3f3f46] border border-[#3f3f46] rounded-lg transition cursor-pointer active:scale-95"
              >
